...
Options = pidtuneOptions('PhaseMargin',0);
C3 = pidtune(Plant3,pidstd(1,6,0,1,Tm_bi),5)
C3.InputName = 'e';
C3.OutputName = 'u';
% -----------------------------------------------------------------------------------
...
% Entrada Escalon
E3 = tf(1,[1 0]);
E3z = c2d(E3,Tm_bi,'foh');
E3z.InputName = 'ye';
E3z.OutputName = 'ysp';
TE3z = connect(Pz3,Gppz3,Dppz3,C3,Fbil,Sum1,Sum2,Sum3,E3z,{'ye'},'y');
RE3 = tf(TE3z);

% Entrada  Rampa
U3 = tf(1,[1 0 0]);
U3z = c2d(U3,Tm_bi,'foh');
U3z.InputName = 'yr';
U3z.OutputName = 'ysp';
TU3z = connect(Pz3,Gppz3,Dppz3,C3,Fbil,Sum1,Sum2,Sum3,U3z,{'yr'},'y');
RU3 = tf(TU3z);
